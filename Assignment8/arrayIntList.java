//Bennett Kielbon 
//ITC 155
//Answers added to the bottom of the code 
...
public class ArrayIntList {
    ...
    //QUESTION 3 replaceAll
    
	public void replaceAll(int oldNumber, int newNumber)
	{
		for(int i = 0; i < size; i++)
		{
			if(elementData[i] == oldNumber)
			{
				elementData[i] = newNumber;
			}
		}
	}
}
